...
public class AnyFiveNewCrawler_img {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 2. DB에서 전체 source_id 조회
            System.out.println("2단계: DB에서 전체 source_id 조회");
            conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);

            List<String> allDocumentIds = new ArrayList<>();
            try (PreparedStatement pstmt = conn.prepareStatement(SELECT_ALL_SOURCE_IDS_SQL)) {
            ...
            System.out.println("  > 전체 문서 수: " + allDocumentIds.size());
