...
public class AnyFiveBizJnlCrawler_img {
    ...
    private static final String SELECT_SOURCE_IDS_BY_YEAR_SQL =
            "SELECT source_id FROM biz_jnl_documents WHERE end_year = ? ORDER BY source_id";

    public static void main(String[] args) {
        // 연도가 포함된 경로들 설정
        DOWNLOAD_BASE_PATH = DOWNLOAD_BASE_DIR + "/biz_jnl_img_" + END_YEAR;
